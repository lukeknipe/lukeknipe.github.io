...
function haversine_distance(origin, storeLoc) {
      ...
      var rlat1 = origin.position.lat() * (Math.PI/180); // Convert degrees to radians
      var rlat2 = storeLoc.position.lat() * (Math.PI/180); // Convert degrees to radians
      var difflat = rlat2-rlat1; // Radian difference (latitudes)
      var difflon = (storeLoc.position.lng()-origin.position.lng()) * (Math.PI/180); // Radian difference (longitudes)
