...
function showList(data, stores) {
    ...
    stores.forEach((store) => {
        ...
        const directions = '<a href="https://maps.google.com?saddr=' + olat +',' + olng + '&daddr=' + dlat + ',' + dlng + '"base target="_blank">Get directions</a>';
        panel.insertAdjacentHTML('beforeend', directions);
    });
